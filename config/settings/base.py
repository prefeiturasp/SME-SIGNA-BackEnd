...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "apps.helpers.exception_handler.exception_handler",
}
...
# Em dev você pode também usar CORS_ALLOW_ALL_ORIGINS=True (não recomendado em produção)  # noqa: E501
