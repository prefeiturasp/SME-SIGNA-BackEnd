...
class DesignacaoWriteSerializer(serializers.Serializer):
    ...
    indicado_codigo_cargo_base       = serializers.IntegerField(required=False, allow_null=True)
    indicado_lotacao                 = serializers.CharField(max_length=255)
    indicado_cargo_sobreposto        = serializers.CharField(max_length=255, required=False, default='', allow_blank=True)
    indicado_codigo_cargo_sobreposto = serializers.IntegerField(required=False, allow_null=True)
    indicado_local_exercicio         = serializers.CharField(max_length=255)
    indicado_local_servico           = serializers.CharField(max_length=255, required=False, default='', allow_blank=True)

    # Titular
    titular_nome_civil              = serializers.CharField(max_length=255, required=False, default='', allow_blank=True)
    titular_nome_servidor           = serializers.CharField(max_length=255, required=False, default='', allow_blank=True)
    titular_rf                      = serializers.CharField(max_length=8,   required=False, default='', allow_blank=True)
    titular_vinculo                 = serializers.IntegerField(required=False, allow_null=True)
    titular_cargo_base              = serializers.CharField(max_length=255, required=False, default='', allow_blank=True)
    titular_codigo_cargo_base       = serializers.IntegerField(required=False, allow_null=True)
    titular_lotacao                 = serializers.CharField(max_length=255, required=False, default='', allow_blank=True)
    titular_cargo_sobreposto        = serializers.CharField(max_length=255, required=False, default='', allow_blank=True)
    titular_codigo_cargo_sobreposto = serializers.IntegerField(required=False, allow_null=True)
    titular_local_exercicio         = serializers.CharField(max_length=255, required=False, default='', allow_blank=True)
    titular_local_servico           = serializers.CharField(max_length=255, required=False, default='', allow_blank=True)
...
class DesignacaoReadSerializer(serializers.ModelSerializer):
    ...
    indicado_nome_servidor           = serializers.CharField(source='designacao_detalhe.indicado_nome_servidor',           read_only=True)
    indicado_rf                      = serializers.CharField(source='designacao_detalhe.indicado_rf',                      read_only=True)
    indicado_vinculo                 = serializers.IntegerField(source='designacao_detalhe.indicado_vinculo',              read_only=True)
    indicado_cargo_base              = serializers.CharField(source='designacao_detalhe.indicado_cargo_base',              read_only=True)
    indicado_codigo_cargo_base       = serializers.IntegerField(source='designacao_detalhe.indicado_codigo_cargo_base',   read_only=True, allow_null=True)
    indicado_lotacao                 = serializers.CharField(source='designacao_detalhe.indicado_lotacao',                 read_only=True)
    indicado_cargo_sobreposto        = serializers.CharField(source='designacao_detalhe.indicado_cargo_sobreposto',       read_only=True)
    indicado_codigo_cargo_sobreposto = serializers.IntegerField(source='designacao_detalhe.indicado_codigo_cargo_sobreposto', read_only=True, allow_null=True)
    indicado_local_exercicio         = serializers.CharField(source='designacao_detalhe.indicado_local_exercicio',        read_only=True)
    indicado_local_servico           = serializers.CharField(source='designacao_detalhe.indicado_local_servico',          read_only=True)

    # Titular
    titular_nome_civil              = serializers.CharField(source='designacao_detalhe.titular_nome_civil',              read_only=True)
    titular_nome_servidor           = serializers.CharField(source='designacao_detalhe.titular_nome_servidor',           read_only=True)
    titular_rf                      = serializers.CharField(source='designacao_detalhe.titular_rf',                      read_only=True)
    titular_vinculo                 = serializers.IntegerField(source='designacao_detalhe.titular_vinculo',              read_only=True, allow_null=True)
    titular_cargo_base              = serializers.CharField(source='designacao_detalhe.titular_cargo_base',              read_only=True)
    titular_codigo_cargo_base       = serializers.IntegerField(source='designacao_detalhe.titular_codigo_cargo_base',   read_only=True, allow_null=True)
    titular_lotacao                 = serializers.CharField(source='designacao_detalhe.titular_lotacao',                 read_only=True)
    titular_cargo_sobreposto        = serializers.CharField(source='designacao_detalhe.titular_cargo_sobreposto',       read_only=True)
    titular_codigo_cargo_sobreposto = serializers.IntegerField(source='designacao_detalhe.titular_codigo_cargo_sobreposto', read_only=True, allow_null=True)
    titular_local_exercicio         = serializers.CharField(source='designacao_detalhe.titular_local_exercicio',        read_only=True)
    titular_local_servico           = serializers.CharField(source='designacao_detalhe.titular_local_servico',          read_only=True)

    # Período
    data_inicio = serializers.DateField(source='designacao_detalhe.data_inicio', read_only=True)
    ...
    # Vaga
    tipo_vaga         = serializers.CharField(source='designacao_detalhe.tipo_vaga',  read_only=True)
    cargo_vaga        = serializers.IntegerField(source='designacao_detalhe.cargo_vaga', read_only=True, allow_null=True)
    ...
    class Meta:
        ...
        fields = [
            ...
            'indicado_lotacao', 'indicado_cargo_sobreposto', 'indicado_codigo_cargo_sobreposto',
            'indicado_local_exercicio', 'indicado_local_servico',
            # Titular
            'titular_nome_civil', 'titular_nome_servidor', 'titular_rf',
            'titular_vinculo', 'titular_cargo_base', 'titular_codigo_cargo_base',
            'titular_lotacao', 'titular_cargo_sobreposto', 'titular_codigo_cargo_sobreposto',
            'titular_local_exercicio', 'titular_local_servico',
            # Período
            ...
            # Vaga
            'tipo_vaga', 'cargo_vaga', 'tipo_vaga_display', 'cargo_vaga_display',
            # Filhos
            'cessacao', 'apostilas', 'insubsistencia',
        ]
